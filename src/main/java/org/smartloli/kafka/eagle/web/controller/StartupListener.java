...
public class StartupListener implements ApplicationContextAware {
	...
	public void setApplicationContext(ApplicationContext arg0) throws BeansException {
		//use spring boot datasorce to overwrite the url
		SystemConfigUtils.setProperties("kafka.eagle.url",dataSourceProperties.getUrl());
		SystemConfigUtils.setProperties("kafka.eagle.username",dataSourceProperties.getUsername());
		SystemConfigUtils.setProperties("kafka.eagle.password",dataSourceProperties.getPassword());
		SystemConfigUtils.setProperties("kafka.eagle.driver",dataSourceProperties.getDriverClassName());
...
//		}
	...
	class ContextSchema extends Thread {
		public void run() {
			String jdbc = dataSourceProperties.getDriverClassName();
